...
class PageMetricsHostRemote {
    ...
    onPageRemoteCreated(page) {
        this.proxy.sendMessage(1176950055, PageMetricsHost_OnPageRemoteCreated_ParamsSpec.$, null, [page])
    }
    onGetMark(name) {
        return this.proxy.sendMessage(696354054, PageMetricsHost_OnGetMark_ParamsSpec.$, PageMetricsHost_OnGetMark_ResponseParamsSpec.$, [name])
    }
    onClearMark(name) {
        this.proxy.sendMessage(472292070, PageMetricsHost_OnClearMark_ParamsSpec.$, null, [name])
    }
    onUmaReportTime(name, time) {
        this.proxy.sendMessage(1721206993, PageMetricsHost_OnUmaReportTime_ParamsSpec.$, null, [name, time])
    }
}
...
class PageMetricsRemote {
    ...
    onGetMark(name) {
        return this.proxy.sendMessage(794950928, PageMetrics_OnGetMark_ParamsSpec.$, PageMetrics_OnGetMark_ResponseParamsSpec.$, [name])
    }
    onClearMark(name) {
        this.proxy.sendMessage(1566656619, PageMetrics_OnClearMark_ParamsSpec.$, null, [name])
    }
}
class PageMetricsCallbackRouter {
    ...
    constructor() {
        ...
        this.helper_internal_.registerHandler(794950928, PageMetrics_OnGetMark_ParamsSpec.$, PageMetrics_OnGetMark_ResponseParamsSpec.$, this.onGetMark.createReceiverHandler(true));
        this.onClearMark = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1566656619, PageMetrics_OnClearMark_ParamsSpec.$, null, this.onClearMark.createReceiverHandler(false));
  ...
  ${this.lazyRender_ ? html$1`
    ...
    <div id="customizeButtons">
      ${this.showWallpaperSearchButton_ ? html$1`
        <cr-button id="wallpaperSearchButton" class="customize-button" @click="${this.onWallpaperSearchClick_}" title="Customise this page with AI" aria-pressed="${this.showWallpaperSearch_}">
      ...
      ` : ""}
      <cr-button id="customizeButton" class="customize-button" @click="${this.onCustomizeClick_}" title="Customise this page" aria-pressed="${this.showCustomize_}">
