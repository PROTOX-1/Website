...
export class FileSuggestionHandlerRemote {
    ...
    getFiles() {
        return this.proxy.sendMessage(877425192, FileSuggestionHandler_GetFiles_ParamsSpec.$, FileSuggestionHandler_GetFiles_ResponseParamsSpec.$, []);
    }
    dismissModule() {
        this.proxy.sendMessage(543131341, FileSuggestionHandler_DismissModule_ParamsSpec.$, null, []);
    }
    restoreModule() {
        this.proxy.sendMessage(1084870978, FileSuggestionHandler_RestoreModule_ParamsSpec.$, null, []);
    }
}
;
/**
...
export class FileSuggestionHandlerReceiver {
    constructor(impl) {
        ...
        this.helper_internal_.registerHandler(877425192, FileSuggestionHandler_GetFiles_ParamsSpec.$, FileSuggestionHandler_GetFiles_ResponseParamsSpec.$, impl.getFiles.bind(impl));
        this.helper_internal_.registerHandler(543131341, FileSuggestionHandler_DismissModule_ParamsSpec.$, null, impl.dismissModule.bind(impl));
        this.helper_internal_.registerHandler(1084870978, FileSuggestionHandler_RestoreModule_ParamsSpec.$, null, impl.restoreModule.bind(impl));
...
export class FileSuggestionHandlerCallbackRouter {
    constructor() {
        ...
        this.helper_internal_.registerHandler(877425192, FileSuggestionHandler_GetFiles_ParamsSpec.$, FileSuggestionHandler_GetFiles_ResponseParamsSpec.$, this.getFiles.createReceiverHandler(true /* expectsResponse */));
        this.dismissModule =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(543131341, FileSuggestionHandler_DismissModule_ParamsSpec.$, null, this.dismissModule.createReceiverHandler(false /* expectsResponse */));
        this.restoreModule =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1084870978, FileSuggestionHandler_RestoreModule_ParamsSpec.$, null, this.restoreModule.createReceiverHandler(false /* expectsResponse */));
        this.onConnectionError = this.helper_internal_.getConnectionErrorEventRouter();
    }
    /**
